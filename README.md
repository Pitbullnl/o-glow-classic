...
```
./package.sh           # builds Era, TBC Anniversary, MoP, and Forever zips into dist/
...
./package.sh forever   # build only the WoW Forever beta package
```
...
* `oGlowClassic-0.3.15-forever.zip` for WoW Forever beta 1.60.1 (Interface `16001`)
